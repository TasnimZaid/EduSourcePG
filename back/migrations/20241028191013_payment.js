exports.up = function(knex) {
    return knex.schema.createTable('payments', function(table) {
        ...
        table.decimal('amount', 10, 2).notNullable(); // Total payment amount
        table.decimal('teacher_earnings', 10, 2).notNullable().defaultTo(0); // Teacher's share (90%)
        table.decimal('site_earnings', 10, 2).notNullable().defaultTo(0); // Site's share (10%)
