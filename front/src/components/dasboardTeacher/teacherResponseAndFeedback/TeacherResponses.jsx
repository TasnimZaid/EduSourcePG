...
const storedUser = sessionStorage.getItem('teacherId');
  ...
  const handlePayment = async (responseId) => {
    try {
      // Implement your payment logic here
      console.log('Processing payment for response:', responseId);
      // Example:
      // await axios.post(`/api/payments/response/${responseId}`);
      // After successful payment, refresh the responses
