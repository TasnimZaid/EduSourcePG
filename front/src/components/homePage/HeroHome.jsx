  ...
  const slides = [
    {
      ...
      description: "EduSource: Your comprehensive platform for educational resources. Empower teachers, engage students, and revolutionize the learning experience."
    },
    {
      title: "INNOVATIVE LEARNING",
      subtitle: "BRIDGING KNOWLEDGE GAPS",
      description: "Discover a world of interactive lessons, cutting-edge tools, and collaborative spaces designed to enhance the educational journey."
    },
    {
      title: "FUTURE-READY SKILLS",
      subtitle: "PREPARING FOR TOMORROW",
      description: "Equip learners with the skills they need to thrive in a rapidly evolving world. From coding to critical thinking, we've got you covered."
    }
  ];
  ...
  return (
    <div className="relative flex h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full text-center text-[#2F32A2] px-4">
        ...
        <h2 className="text-3xl font-semibold text-cyan-300 mb-6 animate-slide-in-bottom">
          ...
          {slides.map((_, index) => (
            <div
              ...
              className={`w-2 h-2 rounded-full ${
                index === currentSlide ? "bg-[#2F32A2]" : "bg-[#2F32A2] bg-opacity-50"
              }`}
            ></div>
          ))}
        </div>
